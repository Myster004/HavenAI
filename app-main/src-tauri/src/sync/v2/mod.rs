...
pub use batch::{
    apply_staged_batch, revision_batch_hash, stage_revision_batch, BatchApplyResult, BatchError,
    StageOutcome,
};
pub use blob_store::{
    begin_blob_receive, blob_content_hash, finish_blob_receive, read_blob_chunk, write_blob_chunk,
    BlobError, BlobReceiveState,
};
pub use capture::{
...
pub use catalog::{
    audit_sync_catalog, cached_schema_fingerprint, schema_fingerprint, syncable_tables,
