...
use super::batch::{MAX_BATCH_BYTES, MAX_REVISIONS_PER_BATCH, MAX_REVISION_BYTES};
...
pub fn validate_hello(local: &SyncHello, peer: &SyncHello) -> Result<SyncLimits, HelloError> {
...
mod tests {
    use super::{
        validate_hello, HelloError, SyncHello, SyncLimits, SyncV2Message, SYNC_V2_PROTOCOL_VERSION,
    };
