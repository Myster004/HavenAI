...
use crate::sync::models::{SyncAsrCorrection, SyncAsrIgnoredSuggestion, SyncAsrVocabularyTerm};
...
pub(crate) fn fetch_corrections(conn: &DbConnection) -> Result<Vec<SyncAsrCorrection>, String> {
    let mut statement = conn
        .prepare(
