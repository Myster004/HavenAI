...
export const idMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      github: {
        ...
        subtitle: "Bug & umpan balik â€¢ v{{version}}",
      },
      discord: {
  ...
  about: {
    ...
    update: {
      ...
      autoChecksDescription: "Saat diaktifkan, MYnestAI akan memeriksa versi baru ketika aplikasi dibuka.",
  ...
  components: {
    ...
    backgroundPosition: {
      ...
      instructions: "Seret untuk memposisikan â€¢ Cubit atau gulir untuk memperbesar",
    },
    avatarSource: {
    ...
    embeddingDownload: {
      ...
      localStorage: "â€¢ Model akan disimpan secara lokal di perangkat Anda",
      downloadSize: "â€¢ Ukuran unduhan: sekitar 260 MB",
      summarization: "â€¢ Diperlukan untuk ringkasan percakapan",
    },
    embeddingUpgrade: {
  ...
  chats: {
    ...
    message: {
      thinkingMessages: {
        thinkingReallyHard: "Berpikir sangat kerasâ€¦",
        lettuceCouncil: "Berkonsultasi dengan dewan seladaâ€¦",
        stealingThoughts: "Mencuri pikiran dari kekosonganâ€¦",
        warmingBrainCells: "Memanaskan sel-sel otakâ€¦",
        forbiddenKnowledge: "Memuat pengetahuan terlarangâ€¦",
        overthinking: "Terlalu banyak berpikir (seperti biasa)â€¦",
        pretendingToBeSmart: "Berpura-pura pintarâ€¦",
        crunchingNumbers: "Menghitung angka imajinerâ€¦",
        arguingWithMyself: "Berdebat dengan diri sendiriâ€¦",
        askingUniverse: "Meminta alam semesta dengan sopanâ€¦",
      },
    ...
    companionMemoryPage: {
      ...
      stalled: "tidak ada respons dari model Â· macet {{seconds}}d",
      generatingTokens: "menghasilkan Â· {{count}} token",
      ...
      storeSummary: "{{total}} total Â· {{pinned}} tersemat",
      ...
      waitingForOutput: "Menunggu keluaranâ€¦",
    ...
    memories: {
      ...
      processingMemories: "Memproses memori...",
      generationStalled: "tidak ada respons dari model Â· macet {{seconds}}d",
      generatingTokens: "menghasilkan Â· {{tokens}} token",
      viewLiveOutput: "Lihat keluaran langsung",
      ...
      cycleWaitingForApproval: "Menunggu persetujuan Â· {{count}} pesan dalam antrean",
      cycleManualReady: "{{count}} pesan siap Â· jalankan secara manual",
  ...
  groupChats: {
    ...
    message: {
      thinkingHard: "Berpikir sangat kerasâ€¦",
      thinkingLettuce: "Berkonsultasi dengan dewan seladaâ€¦",
      thinkingVoid: "Mencuri pikiran dari kekosonganâ€¦",
      thinkingBrainCells: "Memanaskan sel-sel otakâ€¦",
      thinkingForbidden: "Memuat pengetahuan terlarangâ€¦",
      thinkingOverthinking: "Terlalu banyak berpikir (seperti biasa)â€¦",
      thinkingPretending: "Berpura-pura pintarâ€¦",
      thinkingCrunching: "Menghitung angka imajinerâ€¦",
      thinkingArguing: "Berdebat dengan diri sendiriâ€¦",
      thinkingUniverse: "Meminta alam semesta dengan sopanâ€¦",
      thoughtProcess: "Proses pemikiran",
      userAlt: "Pengguna",
    ...
    groupSettings: {
      ...
      characters: "Karakter",
      participantsActive: "{{total}} peserta Â· {{active}} aktif",
      add: "Tambah",
      muted: "(dibisukan)",
  ...
  characters: {
    ...
    lorebook: {
      ...
      preview: {
        ...
        matchCount: "{{hits}} cocok Â· {{entries}} entri",
        emptyMessage: "(kosong)",
        roleUser: "Pengguna",
        ...
        sectionInactive: "Nonaktif Â· {{count}}",
        statusMatched: "Cocok",
        statusAlways: "Selalu",
        statusDisabled: "Mati",
    ...
    description: {
      ...
      addVoicesHint: "Tambahkan suara di Pengaturan â†’ Suara",
  ...
  hfBrowser: {
    ...
    upgradeSuggestion: "{{quant}} ({{size}}) juga muat dan mendapat skor {{score}} â€” kualitas lebih baik.",
    ...
    kvDistributionTip: "{{pct}}% cache KV ada di RAM. Pemrosesan prompt (prefill) akan lebih lambat â€” 100% GPU menjaganya tetap instan.",
    ...
    destinationNoOllama: "Tidak ada penyedia Ollama dikonfigurasi. Tambah satu di Pengaturan â†’ Penyedia untuk menarik model ke instance jarak jauh.",
    ...
    bundle: {
      ...
      subtitle: "Pilih arsitektur dan komponen yang kompatibel. MYnestAI mengunci revisi, memverifikasi, mengunduh, dan mendaftarkan seluruh bundel.",
      ...
      calculating: "Menghitung penempatan dengan kebijakan komputasi tersimpanâ€¦",
      ...
      reserve: "cadangan",
      deviceUsable: "{{free}} kosong Â· {{budget}} dapat dipakai dari {{total}}",
    ...
    headroomLeft: "{{label}} Â· {{size}} tersisa",
    ...
    runabilityTooltip: "Kemampuan jalan: {{score}}/100 ({{label}}) Â· {{mode}}{{ram}}{{vram}}",
    fitsInRam: " Â· Muat di RAM",
    fitsInVram: " Â· Muat di VRAM",
  ...
  systemPrompts: {
    ...
    preview: {
      ...
      injection: {
        relative: "relatif",
        inChat: "dalamObrolan Â· kedalaman {{depth}}",
        conditional: "kondisional Â· min {{min}}",
        interval: "interval Â· setiap {{every}}",
      },
    },
    page: {
  ...
  advanced: {
    ...
    usageAnalytics: {
      ...
      openRouterApiKeyRequired: "Kunci API OpenRouter diperlukan. Konfigurasikan di Pengaturan â†’ Penyedia.",
  ...
  backup: {
    ...
    footer: {
      note: "Cadangan disimpan sebagai berkas .zip terenkripsi di folder Unduhan Anda. Jika sebuah cadangan tidak muncul, ketuk \"Telusuri Berkas\" untuk memilihnya secara manual.",
    },
    export: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      installedMemoryModel: "Model memori terpasang {{version}} Â· {{tokens}} token Â· {{dimensions}}d",
  ...
  developer: {
    ...
    status: {
      testCharacterCreated: "âœ“ Karakter tes berhasil dibuat",
      testPersonaCreated: "âœ“ Persona tes berhasil dibuat",
      testSessionCreated: "âœ“ Sesi tes dibuat: {{id}}",
      generatingBulkData: "Membuat data tes massal...",
      bulkDataCreated: "âœ“ Data tes massal dibuat: 3 karakter, 2 persona",
      creatingBenchmarkChat: "Membuat karakter dan sesi benchmark yang sudah disemai...",
      seededBenchmarkReady: "âœ“ Benchmark yang disemai siap: {{name}} / {{id}}",
      creatingBenchmarkGroupChat: "Membuat obrolan grup benchmark yang disemai...",
      seededGroupBenchmarkReady: "âœ“ Benchmark grup yang disemai siap: {{id}}",
      dbOptimized: "âœ“ Database dioptimalkan",
      recalculatingCosts: "Menghitung ulang biaya penggunaan... Ini mungkin memakan waktu.",
      toursReset: "âœ“ Semua tur panduan direset â€” akan muncul lagi pada kunjungan berikutnya",
    ...
    extra: {
      ...
      successChar: "âœ“ Karakter tes berhasil dibuat",
      successPersona: "âœ“ Persona tes berhasil dibuat",
      successSession: "âœ“ Sesi tes dibuat: {{id}}",
      successBulk: "âœ“ Data tes massal dibuat: 3 karakter, 2 persona",
  ...
  engine: {
    ...
    settingsStep: {
      ...
      subtitle: "Konfigurasi pengaturan engine secara keseluruhan. Semua memiliki bawaan yang masuk akal â€” silakan lewati.",
  ...
  onboarding: {
    ...
    provider: {
      ...
      descriptions: {
        ...
        custom: "Arahkan MYnestAI ke titik akhir model kustom apa pun",
    ...
    model: {
      ...
      setDefaultModelDesc: "Pilih penyedia dan nama model mana yang harus digunakan MYnestAI secara bawaan. Anda akan dapat menambahkan lebih banyak nanti.",
    ...
    welcome: {
      ...
      restoreBackup: {
        ...
        noBackupsHint: "Ketuk jelajahi untuk memilih file .zip",
        browseLettuce: "Jelajahi file .zip",
        passwordLabel: "Kata Sandi Cadangan",
        passwordPlaceholder: "Masukkan kata sandi",
    ...
    modelGuide: {
      ...
      intro: "MYnestAI tidak memaksakan satu model 'terbaik'. Sebaliknya, Anda memilih yang sesuai dengan kasus penggunaan, anggaran, dan selera Anda. Gunakan panduan ini untuk menentukan apa yang perlu dicoba dan ke mana mencarinya.",
      ...
      rules: {
        ...
        switch: "Jika ada yang terasa tidak beres (terlalu lambat / terlalu bodoh / terlalu mahal): Anda selalu dapat beralih model nanti di MYnestAI.",
      },
    ...
    whereToFind: {
      ...
      intro: "Ikuti langkah-langkah ini untuk mendapatkan kunci API Anda, lalu kembali ke MYnestAI dan tempelkan ke pengaturan penyedia.",
      ...
      guides: {
        chutes: {
          ...
          s4: "Tempelkan kunci ke MYnestAI.",
        },
        openai: {
          ...
          s4: "Tempelkan kunci ke MYnestAI dan simpan di tempat yang aman. Anda tidak akan melihatnya lagi.",
        },
        anthropic: {
          ...
          s4: "Salin kunci dan tempelkan ke MYnestAI.",
        },
        openrouter: {
        ...
        cerebras: {
          ...
          s3: "Buat kunci baru jika diperlukan.",
          s4: "Salin kunci tersebut dan tempelkan ke MYnestAI.",
        },
      },
    },
    welcomeFooter: {
    ...
    learn: {
      welcome: {
        tag: "Selamat datang",
        title: "Selamat datang di MYnestAI",
    ...
    syncOnboarding: {
      ...
      subtitle: "Pasangkan dengan perangkat yang sudah memiliki MYnestAI terpasang. Data Anda akan disalin melalui jaringan lokal Anda.",
  ...
  sync: {
    ...
    setupSteps: {
      ...
      step2: "Buka Pengaturan â†’ Sinkronisasi Lokal",
    ...
    disclaimer: "Kedua perangkat mengirim dan menerima perubahan melalui jaringan lokal. Keduanya harus memakai versi MYnestAI yang sama.",
    modals: {
  ...
  samplerOrder: {
    ...
    stages: {
      ...
      xtc: {
        label: "XTC",
        desc: "Kecualikan Pilihan Teratas â€” membuang token berprobabilitas tinggi demi variasi.",
      },
      temp: {
        label: "Temperature",
  ...
  lorebookGen: {
    flow: {
      ...
      statusMessages: "{{count}} pesan Â· ~{{tokens}} token",
      statusSelectMessages: "Pilih pesan untuk dihasilkan",
      statusMemories: "{{count}} memori{{summary}} Â· ~{{tokens}} token",
      ...
      stepDrafts: "Draf",
      stepSave: "Simpan",
      planningEntries: "Merencanakan entriâ€¦",
      ...
      alwaysActivePrefix: "selalu aktif Â· ",
      ...
      pasteSourcePlaceholder: "Tempel teks sumberâ€¦",
      filesLabel: "File",
      upload: "Unggah",
      ...
      coherenceProposals: "Proposal koherensi Â· {{count}}",
      ...
      destination: "Tujuan",
      createNewLorebook: "Buat lorebook baru Â· \\\"{{name}}\\\"",
      appendTo: "Tambahkan ke: {{name}}",
      askForChangesTitle: "Minta perubahan: {{title}}",
      describeChangesPlaceholder: "Deskripsikan apa yang harus diubahâ€¦",
      apply: "Terapkan",
      editEntry: "Edit entri",
  ...
  voices: {
    extra: {
      ...
      myVoices: "Suara Saya",
      page: {
        noAudioProvidersHint: "Tambahkan satu di Penyedia â†’ Audio untuk memulai",
    ...
    speechRecognition: {
      ...
      picker: {
        ...
        forMobileSuffix: " Â· untuk mobile",
        forDesktopSuffix: " Â· untuk desktop",
  ...
  editPrompt: {
    ...
    describe: {
      ...
      includeExclude: "{{include}} Â· KECUALIKAN {{exclude}}",
    },
    warnings: {
    ...
    preview: {
      rendered: "Dirender",
      raw: "Mentah",
      selectCharacter: "Pilih karakterâ€¦",
      selectPersona: "Pilih personaâ€¦",
      rendering: "Merenderâ€¦",
    ...
    variablesSheet: {
      ...
      requiredNote: "Wajib:",
      requiredNoteRest: "Variabel yang ditandai dengan â˜… harus disertakan",
      copied: "Disalin",
      copy: "Salin",
      insert: "Masukkan",
    },
  ...
  installedModels: {
    ...
    ollama: {
      ...
      noProviders: "Tidak ada penyedia Ollama dikonfigurasi. Tambah satu di Pengaturan â†’ Penyedia.",
      empty: {
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        warningInfo: "MYnestAI memeriksa akun NanoGPT secara berkala dan memberi peringatan pada 75%, 90%, dan 100%. Setiap peringatan tampil sekali per periode.",
  ...
  helpPage: {
    ...
    title: "Bantuan & FAQ",
    subtitle: "Baru di MYnestAI? Mulai di sini. Dasar-dasar, penjelasan BYOK, dan jawaban atas pertanyaan paling umum.",
    sections: {
      gettingStarted: "Memulai",
    ...
    faq: {
      whatIsMYnestAI: {
        question: "Apa itu MYnestAI?",
        answer: "MYnestAI adalah aplikasi obrolan untuk karakter AI. Berbeda dengan aplikasi yang mengarahkan pesan Anda melalui satu layanan terpusat, MYnestAI memungkinkan Anda membawa kunci API sendiri dari penyedia seperti Mistral, Cerebras, Google AI Studio, OpenAI, Anthropic, atau menjalankan model secara lokal di perangkat Anda. Obrolan Anda tetap berada di perangkat Anda.",
      },
      whatIsApiKey: {
      ...
      noDefaultModel: {
        ...
        p1: "Ini berarti Anda belum menambahkan model apa pun ke MYnestAI, atau Anda telah menambahkan model tetapi karakter yang Anda ajak mengobrol belum memilih satu pun.",
      ...
      charactersPrivate: {
        ...
        answer: "Ya. Karakter yang Anda buat tetap di perangkat Anda. MYnestAI tidak memiliki tombol unggah dan tidak ada server untuk mengunggahnya. Karakter hanya dibagikan jika Anda secara eksplisit mengekspor berkas kartu karakter dan mengirimnya ke suatu tempat sendiri.",
      },
      backupMove: {
        question: "Bagaimana cara mencadangkan atau berpindah ke perangkat lain?",
        before: "Pengaturan ",
        after: " Cadangkan & Pulihkan memungkinkan Anda mengekspor semuanya ke sebuah berkas. Untuk berpindah ke ponsel atau komputer baru, instal MYnestAI di sana dan gunakan opsi \"Sinkronkan dari perangkat lain\" di layar sambutan, atau pulihkan dari berkas cadangan.",
      },
    },
  },
  hostApi: {
  ...
  runtimeDefaults: {
    ...
    llamaManualPlacementBrief: "{{gpu}} lapisan di GPU Â· {{cpu}} di CPU",
    llamaManualPlacementFull: "{{gpu}} di GPU Â· {{cpu}} di CPU Â· total {{total}}",
    llamaEstimatedPlacement: "Perkiraan: {{breakdown}} Â· {{total}} lapisan di GPU",
  ...
  kokoroStudio: {
    locale: {
      americanFemale: "Amerika Â· Perempuan",
      americanMale: "Amerika Â· Laki-laki",
      britishFemale: "Britania Â· Perempuan",
      britishMale: "Britania Â· Laki-laki",
      spanishFemale: "Spanyol Â· Perempuan",
      spanishMale: "Spanyol Â· Laki-laki",
      frenchFemale: "Prancis Â· Perempuan",
      frenchMale: "Prancis Â· Laki-laki",
      hindiFemale: "Hindi Â· Perempuan",
      hindiMale: "Hindi Â· Laki-laki",
      italianFemale: "Italia Â· Perempuan",
      italianMale: "Italia Â· Laki-laki",
      japaneseFemale: "Jepang Â· Perempuan",
      japaneseMale: "Jepang Â· Laki-laki",
      portugueseFemale: "Portugis Â· Perempuan",
      portugueseMale: "Portugis Â· Laki-laki",
      mandarinFemale: "Mandarin Â· Perempuan",
      mandarinMale: "Mandarin Â· Laki-laki",
      other: "Lainnya",
    },
    dismiss: "Abaikan",
    sample: "Sampel",
  ...
  kokoroBlend: {
    ...
    voiceSummary: "{{count}} suara Â· {{speed}}Ã—",
    voiceSummaryPlural: "{{count}} suara Â· {{speed}}Ã—",
    generating: "Menghasilkan...",
    stop: "Berhenti",
    ...
    statusSummary: "{{active}} aktif Â· {{total}} total Â· {{speed}}Ã—",
    cancel: "Batal",
    saving: "Menyimpan...",
    save: "Simpan",
    create: "Buat",
