...
export const filMessages: DeepPartialMessageTree<LocaleMessages> = {
  ...
  settings: {
    ...
    items: {
      ...
      github: {
        ...
        subtitle: "Mga bug at feedback â€¢ v{{version}}",
      },
      discord: {
  ...
  about: {
    ...
    update: {
      ...
      autoChecksDescription: "Kapag naka-enable, titingin ang MYnestAI ng mga bagong bersyon kapag binuksan ang app.",
  ...
  components: {
    ...
    backgroundPosition: {
      ...
      instructions: "I-drag para iposisyon â€¢ Kurutin o mag-scroll para mag-zoom",
    },
    avatarSource: {
    ...
    embeddingDownload: {
      ...
      localStorage: "â€¢ Ang modelo ay ise-store nang lokal sa iyong device",
      downloadSize: "â€¢ Laki ng download: humigit-kumulang 260 MB",
      summarization: "â€¢ Kailangan para sa pagbubuod ng usapan",
    },
    embeddingUpgrade: {
  ...
  chats: {
    ...
    message: {
      thinkingMessages: {
        thinkingReallyHard: "Malalim na nag-iisipâ€¦",
        lettuceCouncil: "Kumokonsulta sa konseho ng lettuceâ€¦",
        stealingThoughts: "Nagnanakaw ng kaisipan mula sa kawalanâ€¦",
        warmingBrainCells: "Nag-iinit ng mga brain cellâ€¦",
        forbiddenKnowledge: "Naglo-load ng ipinagbabawal na kaalamanâ€¦",
        overthinking: "Sobrang nag-iisip (gaya ng dati)â€¦",
        pretendingToBeSmart: "Nagpapanggap na matalinoâ€¦",
        crunchingNumbers: "Nagko-compute ng mga guni-guning numeroâ€¦",
        arguingWithMyself: "Nakikipagtalo sa sarili koâ€¦",
        askingUniverse: "Magalang na nagtatanong sa sansinukobâ€¦",
      },
    ...
    companionMemoryPage: {
      ...
      stalled: "walang tugon mula sa model Â· na-stall ng {{seconds}}s",
      generatingTokens: "gumagawa Â· {{count}} na token",
      ...
      storeSummary: "{{total}} kabuuan Â· {{pinned}} naka-pin",
      ...
      filters: {
        ...
        active: "Aktibo Â· {{count}}",
        superseded: "Napalitan Â· {{count}}",
        all: "Lahat",
      },
      aiCount: "{{count}} AI",
      youCount: "{{count}} Ikaw",
      ...
      waitingForOutput: "Naghihintay ng outputâ€¦",
    ...
    memories: {
      ...
      processingMemories: "Pinoproseso ang mga memory...",
      generationStalled: "walang tugon mula sa model Â· na-stall ng {{seconds}}s",
      generatingTokens: "gumagawa Â· {{tokens}} na token",
      viewLiveOutput: "Tingnan ang live output",
      ...
      cycleWaitingForApproval: "Naghihintay ng pag-apruba Â· {{count}} mensahe naka-queue",
      cycleManualReady: "{{count}} mensahe handa na Â· patakbuhin nang manu-mano",
  ...
  groupChats: {
    ...
    message: {
      thinkingHard: "Malalim na nag-iisipâ€¦",
      thinkingLettuce: "Kumokonsulta sa konseho ng lettuceâ€¦",
      thinkingVoid: "Nagnanakaw ng kaisipan mula sa kawalanâ€¦",
      thinkingBrainCells: "Nag-iinit ng mga brain cellâ€¦",
      thinkingForbidden: "Naglo-load ng ipinagbabawal na kaalamanâ€¦",
      thinkingOverthinking: "Sobrang nag-iisip (gaya ng dati)â€¦",
      thinkingPretending: "Nagpapanggap na matalinoâ€¦",
      thinkingCrunching: "Nagko-compute ng mga guni-guning numeroâ€¦",
      thinkingArguing: "Nakikipagtalo sa sarili koâ€¦",
      thinkingUniverse: "Magalang na nagtatanong sa sansinukobâ€¦",
      thoughtProcess: "Proseso ng pag-iisip",
      userAlt: "User",
    ...
    groupSettings: {
      ...
      characters: "Mga karakter",
      participantsActive: "{{total}} mga kalahok Â· {{active}} aktibo",
      add: "Idagdag",
      muted: "(naka-mute)",
  ...
  characters: {
    ...
    soulEditor: {
      ...
      sharedMemoryDesc: "Iisa ang memory pool ng mga bago at kasalukuyang chat sa companion na ito. Nagpapatuloy sa ibaâ€™t ibang chat ang paglago ng Soul at relasyon sa bawat persona; nananatili sa kasalukuyang chat ang agarang emosyon.",
  ...
  installedModels: {
    ...
    ollama: {
      ...
      noProviders: "Walang naka-configure na Ollama provider. Magdagdag ng isa sa Settings â†’ Providers.",
      empty: {
  ...
  hfBrowser: {
    ...
    upgradeSuggestion: "{{quant}} ({{size}}) kasya rin at may score na {{score}} â€” mas magandang kalidad.",
    ...
    kvDistributionTip: "{{pct}}% ng KV cache ay nasa RAM. Ang prompt processing (prefill) ay magiging mas mabagal â€” 100% GPU para instant.",
    ...
    destinationNoOllama: "Walang naka-configure na Ollama provider. Magdagdag ng isa sa Settings â†’ Providers para mag-pull ng model sa remote instance.",
    ...
    bundle: {
      ...
      subtitle: "Pumili ng compatible na architecture at mga component. Ipi-pin, ibe-verify, ida-download, at irerehistro ng MYnestAI ang buong bundle.",
      ...
      calculating: "Kinakalkula ang placement gamit ang naka-save na compute policyâ€¦",
      ...
      reserve: "reserba",
      deviceUsable: "{{free}} libre Â· {{budget}} magagamit sa {{total}}",
    ...
    headroomLeft: "{{label}} Â· {{size}} natitira",
    ...
    runabilityTooltip: "Runability: {{score}}/100 ({{label}}) Â· {{mode}}{{ram}}{{vram}}",
    fitsInRam: " Â· Kasya sa RAM",
    fitsInVram: " Â· Kasya sa VRAM",
  ...
  systemPrompts: {
    ...
    preview: {
      ...
      injection: {
        relative: "relatibo",
        inChat: "inChat Â· lalim {{depth}}",
        conditional: "kundisyonal Â· min {{min}}",
        interval: "pagitan Â· bawat {{every}}",
      },
    },
    page: {
  ...
  advanced: {
    ...
    usageAnalytics: {
      ...
      openRouterApiKeyRequired: "Kailangan ng OpenRouter API key. I-configure ito sa Settings â†’ Providers.",
  ...
  backup: {
    ...
    restore: {
      ...
      browseDesc: "Mag-browse para sa .zip file",
    ...
    footer: {
      note: "Ang mga backup ay naka-save bilang encrypted .zip files sa iyong Downloads folder. Kung hindi lumalabas ang backup, i-tap ang \\\"Browse Files\\\" para piliin ito nang manu-mano.",
    },
    export: {
  ...
  dynamicMemory: {
    ...
    page: {
      ...
      installedMemoryModel: "Naka-install na memory model {{version}} Â· {{tokens}} tokens Â· {{dimensions}}d",
  ...
  developer: {
    ...
    status: {
      testCharacterCreated: "âœ“ Matagumpay na nagawa ang test character",
      testPersonaCreated: "âœ“ Matagumpay na nagawa ang test persona",
      testSessionCreated: "âœ“ Nagawa ang test session: {{id}}",
      generatingBulkData: "Gumagawa ng maramihang test data...",
      bulkDataCreated: "âœ“ Nagawa ang maramihang test data: 3 karakter, 2 persona",
      creatingBenchmarkChat: "Gumagawa ng seeded benchmark character at session...",
      seededBenchmarkReady: "âœ“ Handang seeded benchmark: {{name}} / {{id}}",
      creatingBenchmarkGroupChat: "Gumagawa ng seeded benchmark group chat...",
      seededGroupBenchmarkReady: "âœ“ Handang seeded group benchmark: {{id}}",
      dbOptimized: "âœ“ Na-optimize ang database",
      recalculatingCosts: "Kinakalkula ulit ang mga gastos sa paggamit... Maaaring magtagal ito.",
      toursReset: "âœ“ Lahat ng guided tour ay na-reset â€” lalabas ulit sila sa susunod na pagbisita",
    ...
    extra: {
      ...
      successChar: "âœ“ Matagumpay na nagawa ang test character",
      successPersona: "âœ“ Matagumpay na nagawa ang test persona",
      successSession: "âœ“ Nagawa ang test session: {{id}}",
      successBulk: "âœ“ Nagawa ang maramihang test data: 3 karakter, 2 persona",
  ...
  engine: {
    ...
    settingsStep: {
      ...
      subtitle: "I-configure ang mga setting ng engine. Lahat ito ay may makatwirang default â€” huwag mag-atubiling laktawan.",
  ...
  onboarding: {
    ...
    provider: {
      ...
      descriptions: {
        ...
        custom: "Ituro ang MYnestAI sa anumang custom na model endpoint",
    ...
    model: {
      ...
      setDefaultModelDesc: "Pumili kung aling provider at pangalan ng modelo ang gagamitin ng MYnestAI bilang default. Maaari kang magdagdag ng higit pa mamaya.",
    ...
    welcome: {
      ...
      restoreBackup: {
        ...
        noBackupsHint: "Mag-tap ng browse para pumili ng .zip file",
        browseLettuce: "Mag-browse para sa .zip file",
        passwordLabel: "Password ng Backup",
        passwordPlaceholder: "Ilagay ang password",
    ...
    modelGuide: {
      ...
      intro: "Hindi pinipilit ng MYnestAI ang isang \"pinakamainam\" na modelo. Sa halip, pinipili mo ang angkop sa iyong <0>gamit, badyet, at kagustuhan</0>. Gamitin ang gabay na ito para mapagpasyahan kung ano ang susubukan at saan ito hahanapin.",
      ...
      rules: {
        ...
        switch: "Kung may pakiramdam kang may mali (masyadong mabagal / masyadong mangmang / masyadong mahal): maaari kang palipat ng modelo mamaya sa MYnestAI.",
      },
    ...
    whereToFind: {
      ...
      intro: "Sundin ang mga hakbang na ito para makuha ang iyong API key, pagkatapos ay bumalik sa MYnestAI at i-paste ito sa mga setting ng provider.",
      ...
      guides: {
        chutes: {
          ...
          s4: "I-paste ang key sa MYnestAI.",
        },
        openai: {
          ...
          s4: "I-paste ang key sa MYnestAI at itago ito sa ligtas na lugar. Hindi mo na ito makikita muli.",
        },
        anthropic: {
          ...
          s4: "Kopyahin ang key at i-paste ito sa MYnestAI.",
        },
        openrouter: {
    ...
    learn: {
      welcome: {
        ...
        title: "Maligayang pagdating sa MYnestAI",
    ...
    syncOnboarding: {
      ...
      subtitle: "I-pair sa isang device na may MYnestAI na naka-set up na. Ang iyong data ay kokopyahin sa iyong local network.",
  ...
  sync: {
    ...
    setupSteps: {
      ...
      step2: "Pumunta sa Settings â†’ Lokal na Sync",
    ...
    disclaimer: "Parehong nagpapadala at tumatanggap ng pagbabago ang mga device sa lokal na network. Dapat pareho ang bersyon ng MYnestAI.",
    modals: {
  ...
  samplerOrder: {
    ...
    stages: {
      ...
      xtc: {
        label: "XTC",
        desc: "Exclude Top Choices â€” inaalis ang mga high-probability na token para sa pagkakaiba-iba.",
      },
      temp: {
        label: "Temperature",
  ...
  lorebookGen: {
    flow: {
      ...
      userRole: "USER",
      aiRole: "AI",
      pageTitleWithName: "{{name}} Â· Pag-generate",
      characterFallback: "Karakter",
      mixed: "Halo",
      roleAll: "Lahat",
      lastLabel: "Huli",
      ...
      statusMessages: "{{count}} mensahe Â· ~{{tokens}} tokens",
      statusSelectMessages: "Piliin ang mga mensahe para i-generate",
      statusMemories: "{{count}} memorya{{summary}} Â· ~{{tokens}} tokens",
      ...
      stepSave: "I-save",
      planningEntries: "Pinaplano ang mga entryâ€¦",
      ...
      alwaysActivePrefix: "laging active Â· ",
      keysCount: "{{count}} key",
      ...
      pasteSourcePlaceholder: "I-paste ang source textâ€¦",
      filesLabel: "Mga File",
      upload: "I-upload",
      ...
      coherenceProposals: "Mga panukala sa coherence Â· {{count}}",
      ...
      destination: "Destinasyon",
      createNewLorebook: "Gumawa ng bagong lorebook Â· \\\"{{name}}\\\"",
      appendTo: "Idagdag sa: {{name}}",
      askForChangesTitle: "Humingi ng mga pagbabago: {{title}}",
      describeChangesPlaceholder: "Ilarawan kung ano ang babaguhinâ€¦",
      apply: "Ilapat",
      editEntry: "I-edit ang entry",
  ...
  voices: {
    extra: {
      ...
      myVoices: "Aking mga Boses",
      page: {
        noAudioProvidersHint: "Magdagdag ng isa sa Providers â†’ Audio para magsimula",
    ...
    speechRecognition: {
      ...
      picker: {
        ...
        forMobileSuffix: " Â· para sa mobile",
        forDesktopSuffix: " Â· para sa desktop",
  ...
  editPrompt: {
    ...
    describe: {
      ...
      includeExclude: "{{include}} Â· IBUKOD {{exclude}}",
    ...
    preview: {
      rendered: "Na-render",
      raw: "Raw",
      selectCharacter: "Pumili ng characterâ€¦",
      selectPersona: "Pumili ng personaâ€¦",
      rendering: "Nagre-renderâ€¦",
    ...
    variablesSheet: {
      ...
      requiredNoteRest: "Dapat isama ang mga variable na may markang â˜…",
      copied: "Nakopya",
      copy: "Kopyahin",
      insert: "Ipasok",
    },
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        warningInfo: "Regular na sinusuri ng MYnestAI ang mga NanoGPT account at nagbababala sa 75%, 90%, at 100%. Isang beses lang ipinapakita ang bawat babala kada period.",
  ...
  helpPage: {
    ...
    title: "Tulong & FAQ",
    subtitle: "Bago sa MYnestAI? Magsimula rito. Ang mga basic, paliwanag tungkol sa BYOK, at mga sagot sa mga pinakakaraniwang tanong.",
    sections: {
      gettingStarted: "Pagsisimula",
    ...
    faq: {
      whatIsMYnestAI: {
        question: "Ano ang MYnestAI?",
        answer: "Ang MYnestAI ay isang chat app para sa mga AI character. Hindi tulad ng mga app na idinadaan ang iyong mga mensahe sa isang hosted service, hinahayaan ka ng MYnestAI na magdala ng sarili mong API key mula sa mga provider tulad ng Mistral, Cerebras, Google AI Studio, OpenAI, Anthropic, o magpatakbo ng mga model nang lokal sa iyong device. Ang iyong mga chat ay nananatili sa iyong device.",
      },
      whatIsApiKey: {
      ...
      training: {
        ...
        answer: "Depende iyon sa policy ng provider, hindi sa MYnestAI. Karamihan sa mga paid API tier (OpenAI, Anthropic, Mistral) ay hindi nag-te-train sa API traffic by default. Ang mga free tier ay minsan gumagawa nito. Kung mahalaga ito sa iyo, basahin ang privacy page ng provider na iyong ginagamit.",
      },
      whatIsModel: {
      ...
      noDefaultModel: {
        ...
        p1: "Ibig sabihin nito ay maaaring hindi ka pa nagdagdag ng anumang model sa MYnestAI, o nagdagdag ka ng mga model ngunit ang character na kinakausap mo ay walang napiling model.",
      ...
      charactersPrivate: {
        ...
        answer: "Oo. Ang mga character na ginagawa mo ay nananatili sa iyong device. Ang MYnestAI ay walang upload button at walang server para i-upload sila. Ibinabahagi lamang sila kung tahasan mong i-export ang isang character card file at ipadala ito sa kahit saan nang ikaw mismo.",
      },
      backupMove: {
        question: "Paano ako mag-ba-backup o lilipat sa ibang device?",
        before: "Settings ",
        after: " Backup & Restore ay nagpapahintulot sa iyong i-export ang lahat sa isang file. Para lumipat sa bagong phone o computer, i-install ang MYnestAI doon at gamitin ang \\\"Sync from another device\\\" option sa welcome screen, o i-restore mula sa isang backup file.",
      },
    },
  },
  hostApi: {
  ...
  runtimeDefaults: {
    ...
    llamaManualPlacementBrief: "{{gpu}} na layer sa GPU Â· {{cpu}} sa CPU",
    llamaManualPlacementFull: "{{gpu}} sa GPU Â· {{cpu}} sa CPU Â· {{total}} sa kabuuan",
    llamaEstimatedPlacement: "Tinatayang: {{breakdown}} Â· {{total}} na layer sa GPU",
  ...
  kokoroStudio: {
    locale: {
      americanFemale: "Amerikano Â· Babae",
      americanMale: "Amerikano Â· Lalaki",
      britishFemale: "British Â· Babae",
      britishMale: "British Â· Lalaki",
      spanishFemale: "Espanyol Â· Babae",
      spanishMale: "Espanyol Â· Lalaki",
      frenchFemale: "Pranses Â· Babae",
      frenchMale: "Pranses Â· Lalaki",
      hindiFemale: "Hindi Â· Babae",
      hindiMale: "Hindi Â· Lalaki",
      italianFemale: "Italyano Â· Babae",
      italianMale: "Italyano Â· Lalaki",
      japaneseFemale: "Hapones Â· Babae",
      japaneseMale: "Hapones Â· Lalaki",
      portugueseFemale: "Portuges Â· Babae",
      portugueseMale: "Portuges Â· Lalaki",
      mandarinFemale: "Mandarin Â· Babae",
      mandarinMale: "Mandarin Â· Lalaki",
      other: "Iba pa",
    },
    dismiss: "Isara",
    sample: "Sample",
  ...
  kokoroBlend: {
    ...
    testPlaceholder: "Mag-type ng parirala para subukanâ€¦",
    noActiveVoices: "Walang aktibong boses",
    voiceSummary: "{{count}} boses Â· {{speed}}Ã—",
    voiceSummaryPlural: "{{count}} boses Â· {{speed}}Ã—",
    generating: "Gumagawaâ€¦",
    stop: "Ihinto",
    ...
    statusSummary: "{{active}} aktibo Â· {{total}} kabuuan Â· {{speed}}Ã—",
    cancel: "Kanselahin",
    saving: "Sine-saveâ€¦",
    save: "I-save",
    create: "Gumawa",
