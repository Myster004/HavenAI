...
export const enMessages = {
  ...
  about: {
    ...
    update: {
      ...
      autoChecksDescription: "When enabled, MYnestAI checks for new versions when the app opens.",
  ...
  hfBrowser: {
    ...
    bundle: {
      ...
      subtitle: "Choose a compatible architecture and components. MYnestAI pins, verifies, downloads, and registers the complete bundle.",
    ...
    moveToLibrary:
      "This model is outside the MYnestAI GGUF library. Move it into the library to keep local models stored in a single location.",
  ...
  backup: {
    ...
    restore: {
      ...
      browseDesc: "Browse for .zip file",
    ...
    footer: {
      note: 'Backups are saved as encrypted .zip files in your Downloads folder. If a backup isn\'t showing, tap "Browse Files" to select it manually.',
    },
    export: {
  ...
  helpPage: {
    ...
    title: "Help & FAQ",
    subtitle:
      "New to MYnestAI? Start here. The basics, BYOK explained, and answers to the most common questions.",
    sections: {
    ...
    faq: {
      whatIsMYnestAI: {
        question: "What is MYnestAI?",
        answer:
          "MYnestAI is a chat app for AI characters. Unlike apps that route your messages through a single hosted service, MYnestAI lets you bring your own API key from providers like Mistral, Cerebras, Google AI Studio, OpenAI, Anthropic, or run models locally on your device. Your chats stay on your device.",
      },
      whatIsApiKey: {
        ...
        p3: "Most other AI chat apps hide this from you by running their own server in the middle: they hold one big key, you pay them a subscription, and your conversations pass through their machines. MYnestAI doesn't do that. You put your own key in the app, and messages go straight from your device to the provider you picked. Nothing in between.",
      ...
      alternative: {
        ...
        answer:
          "Yes. If you've used an AI chat app where everything just worked but you couldn't pick your model, couldn't control your data, or felt limited by a subscription, MYnestAI is built for that. You bring your own API key, pick the model you want, and your chats stay on your device. The trade-off is a short one-time setup; the upside is total control over cost, quality, and privacy.",
      },
      cost: {
        question: "How much does it cost?",
        answer:
          "MYnestAI itself is free. You pay the model provider directly, usually a fraction of a cent per message. Free tiers exist on Mistral, Cerebras, and Google AI Studio. Heavy use of frontier models (Claude Opus 4.7, GPT-5.1, Gemini 3 Pro) can add up, so check the provider's pricing page before picking a model.",
      },
      apiKeySafe: {
        question: "Is my API key safe?",
        answer:
          "Your API key is stored locally on your device and only ever sent to the provider you configured it for. MYnestAI does not have a server that sees your key or your messages.",
      },
      chatsStored: {
      ...
      chatsDeleted: {
        ...
        answer:
          "No. Chats live in a local database on your device and only you can delete them. They aren't synced to any MYnestAI server, so we can't wipe them, and no automatic cleanup runs in the background. The only ways your chats go away are: you delete them yourself, you uninstall the app, you reset the app, or your device storage is wiped.",
      },
      editRemotely: {
        question: "Can someone edit my data remotely?",
        answer:
          "No. There's no remote admin panel, no MYnestAI account, and no server with a copy of your characters, chats, or settings. Nobody at MYnestAI can push a change to your data, lock you out, or reach into the app to modify anything. Your data only changes when you change it on your own device.",
      },
      shutdown: {
        question: "What happens to my data if MYnestAI shuts down?",
        before:
      ...
      training: {
        ...
        answer:
          "That depends on the provider's policy, not on MYnestAI. Most paid API tiers (OpenAI, Anthropic, Mistral) do not train on API traffic by default. Free tiers sometimes do. If this matters to you, read the privacy page of whichever provider you use.",
      },
      whatIsModel: {
      ...
      noDefaultModel: {
        ...
        p1: "This means either you haven't added any model to MYnestAI yet, or you added models but the character you're chatting with doesn't have one picked.",
      ...
      charactersPrivate: {
        ...
        answer:
          "Yes. Characters you create stay on your device. MYnestAI has no upload button and no server to upload them to. They're only ever shared if you explicitly export a character card file and send it somewhere yourself.",
      },
      backupMove: {
        question: "How do I back up or move to another device?",
        before: "Settings ",
        after:
          ' Backup & Restore lets you export everything to a file. To move to a new phone or computer, install MYnestAI there and use the "Sync from another device" option on the welcome screen, or restore from a backup file.',
      },
    },
  },
  hostApi: {
  ...
  onboarding: {
    ...
    model: {
      ...
      setDefaultModelDesc:
        "Choose which provider and model name MYnestAI should use by default. You'll be able to add more later.",
    ...
    welcome: {
      ...
      restoreBackup: {
        ...
        noBackupsHint: "Tap browse to select a .zip file",
        browseLettuce: "Browse for .zip file",
        passwordLabel: "Backup Password",
        passwordPlaceholder: "Enter password",
    ...
    syncOnboarding: {
      ...
      subtitle:
        "Pair with a device that already has MYnestAI set up. Your data will be copied over your local network.",
      hostHint:
    ...
    modelGuide: {
      ...
      intro:
        'MYnestAI doesn\'t force a single "best" model. Instead, you pick what fits your <0>use case, budget, and vibe</0>. Use this guide to decide what to try and where to look.',
      ...
      rules: {
        ...
        switch:
          "If something feels off (too slow / too dumb / too expensive): you can always switch models later in MYnestAI.",
      },
      disclaimer:
    ...
    whereToFind: {
      badge: "API Key Help",
      intro:
        "Follow these steps to get your API key, then return to MYnestAI and paste it into the provider settings.",
  ...
  sync: {
    ...
    disclaimer: "Both devices send and receive changes over your local network. They must use the same MYnestAI version.",
    modals: {
  ...
  usageAnalytics: {
    page: {
      ...
      nanoGpt: {
        ...
        localSubtitle:
          "Recorded by MYnestAI for NanoGPT requests. Counted separately from the quota above.",
        ...
        warningInfo:
          "MYnestAI rechecks your quota when a request runs through NanoGPT, at most once every 5 minutes, and warns at 75%, 90%, and 100% usage. Each warning is shown once per quota window.",
